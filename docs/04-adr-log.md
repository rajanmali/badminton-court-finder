...
| File | Decision |
|---|---|
| [0001-react-native-expo.md](adr/0001-react-native-expo.md) | React Native (Expo) over native iOS/Android (superseded by ADR-0010) |
...
| [0010-native-ios-swiftui.md](adr/0010-native-ios-swiftui.md) | Native iOS (Swift/SwiftUI) rewrite, supersedes ADR-0001 |
